  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="checkLogin" method="post">
        <div style="text-align:center"><h2 class="form-signin-heading">Sign in for User</h2></div>
        <input type="text" class="input-block-level" placeholder="Email" name="email">
        <input type="password" class="input-block-level" placeholder="Password" name="password">
        <div class="row">
        <input type="radio" name="type" value="administrater">administrater
		<input type="radio" name="type" value="user">user
          <p class="text-center">
            <div style="text-align:center;">
            <input align="middle" type="submit" name="submit" value="login" role="button"/>
            </div>

          </p>
        </div>
        <br>
        <button type="button" class="btn btn-primary"><a href="index.jsp"><-Back</a></button>
      </form>
